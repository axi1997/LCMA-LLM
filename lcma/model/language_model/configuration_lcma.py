...
class LCMAVisionConfig(PretrainedConfig):
    r"""
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        if (config_dict.get("model_type") == "lcma_phi" or config_dict.get("model_type") == "lcma_gemma"
                or config_dict.get("model_type") == "lcma_phi3"):
...
class ProjectorConfig(PretrainedConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        # get the vision config dict if we are loading from CLIPConfig
        if config_dict.get("model_type") == "lcma_phi" or config_dict.get("model_type") == "lcma_gemma" or \
                config_dict.get("model_type") == "lcma_phi3":
...
DEFAULT_VISUAL_CONFIG = {
    "vision_tower": LCMAVisionConfig().to_dict(),
    "mm_projector": ProjectorConfig().to_dict()
}


class LCMAPhiConfig(PhiConfig):
    model_type = "lcma_phi"
...
class LCMAPhi15Config(Phi1_5Config):
    model_type = "lcma_phi15"
...
class LCMAGemmaConfig(GemmaConfig):
    model_type = "lcma_gemma"
...
class LCMAPhi3Config(Phi3Config):
    model_type = "lcma_phi3"
