...
from .language_model.configuration_lcma import LCMAVisionConfig, ProjectorConfig
from lcma.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, \
    DEFAULT_IM_END_TOKEN


class LCMAMetaModel:
    def __init__(self, config):
        super(LCMAMetaModel, self).__init__(config)
        if "clip" in config.vision_config["vision_tower"]["vision_model_name_or_path"]:
            self.vision_tower = CLIPVisionTower(
                LCMAVisionConfig(**config.vision_config["vision_tower"])
            )
