...
from lcma.model.language_model.configuration_lcma import LCMAVisionConfig


class CLIPVisionTower(CLIPPreTrainedModel):
    config_class = LCMAVisionConfig
...
if __name__ == '__main__':
    ...
    print("################ clip_config ##############")
    print(clip_config)
    phi_vis_config = LCMAVisionConfig(**clip_config.to_dict())
